{
    ...
    "NetworkConfiguration": {
        "AwsvpcConfiguration": {
            ...
            "Subnets": [
                "{{ tfstate `data.terraform_remote_state.network.outputs.private_subnet_ids[0]` }}",
                "{{ tfstate `data.terraform_remote_state.network.outputs.private_subnet_ids[1]` }}",
                "{{ tfstate `data.terraform_remote_state.network.outputs.private_subnet_ids[2]` }}"
            ]
        }
    },
    "loadBalancers": [
